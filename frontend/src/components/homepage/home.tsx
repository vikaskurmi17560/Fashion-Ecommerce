...
function Home() {
    return (
        <div className="w-full z-10 flex bg-fixed h-screen flex-col bg-[url('https://websitedemos.net/brandstore-02/wp-content/uploads/sites/150/2019/12/home-new-bg-free-img.jpg')] items-center bg-cover bg-no-repeat bg-center relative before:content-[''] before:absolute before:inset-0 before:block before:bg-gradient-to-tl before:from-black/50 before:to-sky-600 before:opacity-75 before:z-[-5]">
            <Navbar />
