...
function page() {
    const { products, AddCart, getProducts, userid } = useProduct();
    ...
    return (
        <main className='w-screen h-auto flex flex-col items-center bg-slate-100'>
            ...
            <section className='w-[85%] h-auto flex flex-col  bg-slate-100 my-28 '>
                    ...
                    <img src="https://websitedemos.net/brandstore-02/wp-content/uploads/sites/150/2017/12/product-accessory2.jpg" alt="img" className='w-[50%] h-[60vh]' />
                    <div className="w-[50%] h-auto p-4 flex flex-col gap-6">
                        <div className="text-xl text-slate-500 ">Home / Women / Anchor Bracelet</div>
                        <div className="text-black text-xl">Accessories, Women</div>
                        <div className="text-black text-3xl font-extrabold">{item.name}</div>
                        <div className="text-slate-600 text-2xl">$150.00 – $180.00</div>
                        <div className="text-xl text-slate-500">Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus condimentum sit amet a augue. Sed non neque elit sed.</div>
                        <div className="text-black">colors</div>
                        <div className="flex flex-row  justify-center">
                            <button className="bg-blue-500 text-2xl font-extrabold text-white hover:bg-black py-2 text-center rounded-md w-[50%]" >
                                Add To Cart
                            </button>
                        </div>
                    </div>
...

                {
                    option === 1 && <div className=" flex flex-row  w-full h-auto p-4">
                        ...
                        <div className="text-xl text-slate-500 px-10 py-2">Black, Blue, Brown, Red</div>
                    </div>
